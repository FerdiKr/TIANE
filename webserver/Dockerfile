...
RUN ["pip3", "install", "wikipedia", "googlemaps", "spacex_py", "html5lib", "python_dateutil", "spotipy"]
RUN ["apt", "install", "-y", "fortunes-de"]

RUN ["pip3", "install", "flask", "gevent", "werkzeug"]
